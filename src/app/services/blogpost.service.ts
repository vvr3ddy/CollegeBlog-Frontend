...
export class BlogpostService {
  ...
  public findByAuthor(userName: String): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/get/findByAuthor/${userName}`, {
      headers,
      responseType: 'json',
    });
  }
  ...
  public getFlaggedPosts(): Observable<any> {
    ...
    return this.http.get(`${this.baseUrl}/get/flaggedPosts`, {
      headers,
      responseType: 'json',
    });
  }
  ...
  public createNewPost(newPost: newPostDto): Observable<any> {
    ...
    return this.http.post(`${this.baseUrl}/add`, newPost, {
      headers,
      responseType: 'text',
    });
  }
